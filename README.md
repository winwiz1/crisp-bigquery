...
Sample website developed using Crisp BigQuery as starter project: [COVID-19 Query Tool](https://covid.winwiz1.com/).
...
>:bulb: For the browser option you can get the repository cloned and the solution built (with working website you can interact with) in under 15 min. Admittedly, this timeframe does not include the first step e.g. creating Google cloud account if you don't already have one.
